...
class eleicaoRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'start_date_depuracao' => ['required', 'after_or_equal:end_date_inscricao'],
            'start_time_depuracao' => 'required',
            'end_date_depuracao' => ['required', 'after_or_equal:start_date_depuracao'],
            'end_time_depuracao' => 'required',
            'start_date_eleicao' => ['required', 'after_or_equal:end_date_depuracao'],
