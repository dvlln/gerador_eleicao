                ...
                <div class="card-body text-center ">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <span class="font-weight-bold mb-1"><i type="button" class="fa-solid fa-circle-question fa-small" data-toggle="tooltip" data-placement="top" title="Tempo para enviar os documentos de inscrição"></i> Início inscrição:</span>
